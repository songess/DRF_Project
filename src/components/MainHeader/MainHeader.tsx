...
export default function MainHeader({
  ...
  return (
    <header css={header}>
      ...
      {buttonNames.includes('search') && <Search css={headerButton} />}
      {buttonNames.includes('adduser') && <AddUser css={headerButton} />}
      {buttonNames.includes('chat') && <NewChat css={headerButton} />}
